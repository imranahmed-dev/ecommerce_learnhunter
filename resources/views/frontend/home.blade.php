...
$trend = App\Models\Product::where('status',1)->where('trend_product',1)->latest()->get();
                    ...
                    <div class="deals_slider_container">
                        ...
                        <div class="owl-carousel owl-theme deals_slider">
                            ...
                            <div class="owl-item deals_item">
                                <div class="deals_image"><img style="width: 200px;" src="{{asset($product->default_image)}}" alt=""></div>
                                <div class="deals_content">
                                    <div class="deals_info_line d-flex flex-row justify-content-start">
                                        <div class="deals_item_category"><a href="#">{{$product->category->category_name}}</a></div>
                                        @if($product->discount_type == 2)
                                        <div class="deals_item_price_a ml-auto"><del>${{$product->selling_price}}</del></div>
                                        @endif
                                    </div>
                                    <div class="deals_info_line d-flex flex-row justify-content-start">
                                        <div class="deals_item_name">{{Str::limit($product->product_name,15)}}</div>
                            ...
                            <div class="featured_slider slider">
                                ...
                                <div class="featured_slider_item">
                                    ...
                                    <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                        <div class="product_image d-flex flex-column align-items-center justify-content-center"><img src="{{asset($product->default_image)}}" alt=""></div>
                        ...
                        <div class="row fill_height">
                            <div class="col-lg-4 col-md-6 fill_height">
                                <div class="banner_2_content">
                                    <div class="banner_2_category">{{$product->category_category_name}}</div>
                                    <div class="banner_2_title">{{$product->product_name}}</div>
                                     <div class="banner_2_text">{!!$product->product_description!!}</div>
                            ...
                            <div class="col-lg-8 col-md-6 fill_height">
                                <div class="banner_2_image_container">
                                    <div class="banner_2_image"><img style="width: 300px;" src="{{asset($product->default_image)}}" alt=""></div>
                                </div>
                            </div>
                        </div>
                    </div>
